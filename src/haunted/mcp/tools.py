...
class MCPToolHandler:
    ...
    # Database operations
    async def get_issue_context(self, issue_id: int) -> Dict[str, Any]:
        """
    ...
    async def update_issue_status(
        self, issue_id: int, status: str, workflow_stage: Optional[str] = None
    ) -> str:
        """
    ...
    async def create_task(self, issue_id: int, description: str) -> str:
        """
    ...
    async def add_comment(self, issue_id: int, content: str, author: str = "ai") -> str:
        """
    ...
    async def search_code(
        self, pattern: str, file_pattern: str = "*.py"
    ) -> List[Dict[str, Any]]:
        """
            ...
            },
            {
                ...
                "input_schema": {
                    ...
                    "properties": {
                        "operation": {
                            "type": "string",
                            "description": "Git operation (status, add, commit, etc.)",
                        },
                        "args": {
                            "type": "array",
                            "items": {"type": "string"},
